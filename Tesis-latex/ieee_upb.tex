...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Definición de Dashboard]{\textit{Dashboards - Propósito, Capacidades y Expectativas} \cite{zingde2020role}.}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Metodología propuesta a emplear durante el proyecto]{\textit{Metodología para el desarrollo de un dashboard adaptado de la metodología propuesta por Hariyanti\cite{hariyanti-dashboard}.}}
	\label{fig:hariyanti} 
\end{figure}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Cronograma de actividades]{\textit{Cronograma de actividades.}}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Presupuesto para el proyecto.]{\textit{Presupuesto para el proyecto. }}
...
\begin{figure}[H] 
	...
	\vspace{-1mm}
	\caption[Diagrama de entidad-relación de la base de datos de la biblioteca Benedicto XVI]{\textit{Tablas utilizadas en el proyecto.}}
...
La información suele ser considerada de baja calidad si no es exacta, íntegra, consistente y actualizada\cite{DataQuality}. La información en la base de datos de la biblioteca falla en estos principios en gran porcentaje de sus registros.
 ...
 \begin{figure}[H] 
	...
	\vspace{-1mm}
	\caption[Caso 1: Facultades en la base de datos repetidas]{\textit{Dato repetido en la base de datos.}}
...
Al analizar los registros de ejemplares y sus estados, el equipo de trabajo notó que en la base de datos existían errores tipográficos entre los distintos estados. En la figura \ref{fig:problemas-2} se encuentran los estados presentes.
 ...
 \begin{figure}[H] 
	...
	\vspace{-1mm}
	\caption[Caso 2: Errores tipográficos en la base de datos]{\textit{Errores tipográficos}}
  \vspace{-4mm}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Puntos comprometidos primer Sprint]{\textit{Puntos comprometidos para el Primer Sprint. }}
	\label{fig:S1} 
\end{figure}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Primera versión software]{\textit{Primera versión software. }}
	\label{fig:S1-1} 
  \vspace{-4mm}
\end{figure}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Puntos comprometidos segundo Sprint]{\textit{Puntos comprometidos para el Segundo Sprint. }}
	\label{fig:S2} 
  \vspace{-4mm}
\end{figure}
...
\begin{figure}[H] 
	...
	\vspace{-1mm}
	\caption[Segunda iteración del software]{\textit{Segunda iteración del software. }}
	\label{fig:S2-1} 
  \vspace{-4mm}
\end{figure}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Puntos comprometidos para el Tercer Sprint]{\textit{Puntos comprometidos para el Tercer Sprint}}
	\label{fig:S3} 
\end{figure}
...
\begin{figure}[htpb] 
	...
	\vspace{-1mm}
	\caption[Tercera iteración del software]{\textit{Tercera iteración del software. }}
	\label{fig:S3-1} 
  \vspace{-4mm}
\end{figure}
