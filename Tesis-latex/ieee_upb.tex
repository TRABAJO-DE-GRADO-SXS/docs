...
%%AUTENTICACIÓN LO HICIMOS Y EXPUSIMOS UNA INTERFAZ PARA SU POSTERIOR USO EN OTROS PROYECTOS 
...
%%CENTRALIZAR LA AUTENTICACIÓN EN LA SECCIONAL.
%%CENTRAILZAR ALEJANDRIA CON SABIB
%%NORMALIZACION DE LOS ESTADOS DEL INVENTARIO DE LOS LIBROS DE BIBLIOTECA EN LA BASE DE DATOS
%%NORMALIZACIÓN DE LA BASE DATOS (REMOVER TABLAS NO USADAS)
%%EN EL CASO DE QUE SE REALICE LA MIGRACIÓN DE LA BASE DE DATOS, SE RECOMIENDA ACTUALIZAR LOS QUERIES DEL BACK YA QUE ESTOS ESTAN ADAPTADOS PARA MYSQL 5
%%SE RECOMIENDA LEER LA DOCUMENTACIÓN DEL PROYECTO EN CASO DE RETOMARLO PARA EXPANDIRLO. PARA ESTAR FAMILIARIZADOS
%%  AL MOMENTO DE DESPLEGAR PROYECTOS EN LA INFRAESTRUCTURA DE LA UNIVERSIDAD, SE RECOMIENDA REALIZAR UN ARCHIVO .SH. SE DEJA UN EJEMPLO DE ARCHIVO EN LOS ENTREGABLES DEL PROYECTO  
